...
PatoInterfaz::PatoInterfaz(SDL2pp::Renderer& renderer, const std::string& pato_path, int pos_inicial_x, int pos_inicial_y):
    ...
    pato_disparo(renderer, "../resources/weapons/Darts.png", "../resources/weapons/Darts.png", 150, 150)
{}
...
void PatoInterfaz::dibujar(int it, float zoom_factor) {
    ...
    /*else if(estado_arma == DISPARAR || estado_arma == TOMAR_ARMA){
        Disparo pato_disparo = tomar_arma(renderer, get_arma_path(), get_bala_path());
        pato_disparo.mostrar_disparo(estado_pato_movimiento, direccion_pato, pos_x, pos_y, it, zoom_factor);
    }*/
